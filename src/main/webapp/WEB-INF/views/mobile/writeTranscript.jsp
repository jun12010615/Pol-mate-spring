    ...
    <div id="doneSection" class="save-done">
      <div class="card" style="text-align:center;padding:36px 20px;">
        ...
        <div style="display:flex;flex-direction:column;gap:10px;">
          <button onclick="location.href='myCase'" class="btn-save" style="margin-bottom:0;">
...
document.addEventListener('DOMContentLoaded', function() {
  var sel = document.getElementById('caseId');
  sel.addEventListener('change', loadCaseDetailForSelect);
    ...
    .then(function(cases) {
      if (Array.isArray(cases)) {
        cases.forEach(function(c) {
          ...
          var opt = document.createElement('option');
          opt.value = cid;
          opt.textContent = cid + ' · ' + cname;
          sel.appendChild(opt);
        });
      }
      initCaseFromUrl();
    })
    .catch(function() { initCaseFromUrl(); });
});
