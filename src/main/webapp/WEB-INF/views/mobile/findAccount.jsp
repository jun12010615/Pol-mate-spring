    ...
    <div class="tab-panel active" id="panelId">
      ...
      <div id="findIdForm">
        ...
        <p style="text-align:center; margin-top:14px;">
          <a href="login" style="font-size:12px; color:var(--accent); text-decoration:none;">로그인 화면으로 돌아가기</a>
        </p>
      </div>
      ...
      <div id="findIdDone" style="display:none; animation: fadeUp 0.3s ease both;">
        ...
        <button class="btn-submit" onclick="location.href='login'">로그인 화면으로 이동</button>
      </div>
